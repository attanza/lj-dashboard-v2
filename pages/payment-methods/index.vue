<template>
  <v-card>
    ...
    <v-toolbar flat color="transparent">
      <Tbtn
        v-if="checkPermission('create-payment-method')"
        :bottom="true"
...
import { headers, downloadData } from "~/components/payment-methods/util"
import { global, catchError } from "~/mixins"
import { dform } from "~/components/payment-methods"
